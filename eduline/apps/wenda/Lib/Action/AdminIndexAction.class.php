...
class AdminIndexAction extends AdministratorAction{
    ...
    public function _initialize() {
        ...
        // 管理分页项目
        $this->pageTab[] = array('title'=>$this->pageTitle['index'],'tabHash'=>'index','url'=>U('wenda/AdminIndex/index'));
        $this->pageTab[] = array('title'=>$this->pageTitle['cate'],'tabHash'=>'cate','url'=>U('wenda/AdminIndex/cate'));
