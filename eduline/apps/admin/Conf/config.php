	...
	'admin_menu'	=> array(
		...
		'system'	=> array(
			L('PUBLIC_SYSTEM_SETTING')	=>	array(
				...
				'人脸配置'        => U('admin/Config/youtu'),
				'支付宝配置'          =>  U('admin/Config/alipay'),
				'微信支付配置'          =>  U('admin/Config/wxpay'),
		...
		'classroom' => array(
			...
			'订单与账户' => array(
                ...
                'VIP等级'  => U('classroom/AdminVip/index'),
		...
		'live' => array(
			'直播系统' => array(
				'直播课管理' => U('live/AdminLive/index'),
				'直播分类' 	=> U('live/AdminLiveCate/index'),
				'直播配置'  => U('live/AdminConfig/baseConfig'),
			),
		),
		/* # APP seting */
        'application' => array(
            'APP设置' => array(
            	'下载地址'    => U('admin/Application/appConfig'),
                //'app轮播'    => U('admin/Application/index'),
