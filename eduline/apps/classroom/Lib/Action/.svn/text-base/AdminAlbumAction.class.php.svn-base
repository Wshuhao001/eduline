...
class AdminAlbumAction extends AdministratorAction
{
	...
	public function addAlbum(){
		$this->_initClassroomListAdminMenu();
		$this->_initClassroomListAdminTitle();
		$this->pageKeyList = array('album_category','album_title','album_intro','price','album_html','cover','album_tag','listingtime','uctime','is_best');
	...
	public function editAlbum(){
		...
		$this->pageKeyList = array('id','myAdminLevelhidden','album_title','album_intro','price','album_html','cover','album_tag','listingtime','uctime','is_best');
