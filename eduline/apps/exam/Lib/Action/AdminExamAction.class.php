...
class AdminExamAction extends AdministratorAction
{
    ...
    public function index(){
        ...
        $category = M('ex_exam_category')->getField('exam_category_id,exam_category_name');
