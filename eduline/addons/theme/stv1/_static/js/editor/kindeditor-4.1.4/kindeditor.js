...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		'	height:2px;',
		'}',
		'img.tkimg{width:80px;height:25px;background-color:#FFFFCC;}',
...
_plugin('core', function(K) {
	...
	//修改  适用于后台添加填空题
	self.clickToolbar('kong', function() {
		var str = self.html();
		var num = str.split('<img class="tkimg"').length;
		var html = '<img class="tkimg" alt="'+num+'" />';
		//向题目中插入答案框
		self.insertHtml(html, true);
		var ihtml = '<li style="width:400px;"><em>答案'+num+'</em><input name="tk_question_answer'+num+'" type="text"><i data-num="'+num+'" style="cursor:pointer" onclick="removeLi(this)"  href="javascript:void(0)">删除</i></li>';
		$('.box-answer').append(ihtml);
	});
...
KISSY.Editor = function(id , mode , focusset){
	...
	//modeitem['photo']    = ['fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold', 'italic', 'underline','removeformat', '|','image', 'link', 'flash','media','|', 'justifyleft', 'justifycenter', 'justifyright', 'insertorderedlist','insertunorderedlist', '|' ,'fullscreen'];
	//modeitem['more']     = ['fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold', 'italic', 'underline','removeformat', '|', 'justifyleft', 'justifycenter', 'justifyright', 'insertorderedlist','insertunorderedlist', '|',  'fullscreen'];
	modeitem['custom']   = ['fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold', 'italic', 'underline','removeformat', '|','image', 'link', 'flash','|', 'justifyleft', 'justifycenter', 'justifyright', 'insertorderedlist','insertunorderedlist', '|', 'kong' ,'fullscreen'];
	modeitem['simple'] = [ 'bold', 'italic', 'underline',  'forecolor','removeformat', 'justifyleft', 'justifycenter', 'justifyright','emoticons','image'];

	modeitem['full'] = ['source', '|', 'undo', 'redo', '|', 'preview', 'print', 'template', 'code', 'cut', 'copy', 'paste',
		'plainpaste', 'wordpaste', '|', 'justifyleft', 'justifycenter', 'justifyright',
