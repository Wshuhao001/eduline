<?php
require_once dirname(__FILE__).'/Core/MimeTypes.php';
require_once dirname(__FILE__).'/Core/OssException.php';
require_once dirname(__FILE__).'/Http/RequestCore.php';
require_once dirname(__FILE__).'/Http/RequestCore_Exception.php';
require_once dirname(__FILE__).'/Http/ResponseCore.php';
require_once dirname(__FILE__).'/Model/CorsConfig.php';
require_once dirname(__FILE__).'/Model/LoggingConfig.php';
require_once dirname(__FILE__).'/Result/AclResult.php';
require_once dirname(__FILE__).'/Result/BodyResult.php';
require_once dirname(__FILE__).'/Result/GetCorsResult.php';
require_once dirname(__FILE__).'/Result/GetLifecycleResult.php';
require_once dirname(__FILE__).'/Result/GetLoggingResult.php';
require_once dirname(__FILE__).'/Result/GetRefererResult.php';
require_once dirname(__FILE__).'/Result/GetWebsiteResult.php';
require_once dirname(__FILE__).'/Result/HeaderResult.php';
require_once dirname(__FILE__).'/Result/InitiateMultipartUploadResult.php';
require_once dirname(__FILE__).'/Result/ListBucketsResult.php';
require_once dirname(__FILE__).'/Result/ListMultipartUploadResult.php';
require_once dirname(__FILE__).'/Result/ListMultipartUploadInfo.php';
require_once dirname(__FILE__).'/Result/ListObjectsResult.php';
require_once dirname(__FILE__).'/Result/ListPartsResult.php';
require_once dirname(__FILE__).'/Result/PutSetDeleteResult.php';
require_once dirname(__FILE__).'/Result/ExistResult.php';
require_once dirname(__FILE__).'/Model/ObjectListInfo.php';
require_once dirname(__FILE__).'/Model/UploadPartResult.php';
require_once dirname(__FILE__).'/Model/BucketListInfo.php';
require_once dirname(__FILE__).'/Model/LifecycleConfig.php';
require_once dirname(__FILE__).'/Model/RefererConfig.php';
require_once dirname(__FILE__).'/Model/WebsiteConfig.php';
require_once dirname(__FILE__).'/Core/OssUtil.php';
require_once dirname(__FILE__).'/Model/ListPartsInfo.php';
