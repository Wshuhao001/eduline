...
require_once dirname(dirname(__FILE__)) . '/Core/OssUtil.php';
require_once dirname(dirname(__FILE__)) . '/Model/ObjectInfo.php';
require_once dirname(dirname(__FILE__)) . '/Model/ObjectListInfo.php';
require_once dirname(dirname(__FILE__)) . '/Model/PrefixInfo.php';
