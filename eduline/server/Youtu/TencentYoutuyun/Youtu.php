...
class YouTu
{
   ...
   /**
     ...
     * @return mixed|string
     */
    public static function faceverifybase64($imagebase64,$person_id) {
...
//        $image_data = file_get_contents($real_image_path);
	...
	* @return 返回的结果，JSON字符串，字段参见API文档
    ...
    /**
     * @param        $imagebase64  已编码图片
     * @param        $person_id    个体ID
     * @param array  $group_ids    个体存放的组id
     * @param string $person_name  个体存放名字
     * @param string $person_tag   备注信息
     * @return array|mixed|string
     */
//    public static function newpersonbase64($imagebase64, $person_id, array $group_ids, $person_name='', $person_tag=''){
//        return $person_id . $group_ids . $person_name;
//    }
    public static function newpersonbase64($imagebase64, $person_id, array $group_ids, $person_name='', $person_tag='') {
        /* $real_image_path = realpath($imagebase64);
         if (!file_exists($real_image_path))
         {
             return array('httpcode' => 0, 'code' => self::HTTP_BAD_REQUEST, 'message' => 'file '.$image_path.' not exists', 'data' => array());
         }*/
