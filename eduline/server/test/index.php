...
<div class="config">
    ...
    <p><input type="text" id="host" placeholder="socket host" value="beta.51eduline.com" /></p>
    ...
    <div>
        <select id="change_pack">
            ...
            <option value="input_status">input_status(输入状态)</option>
        ...
        <form id="login_pack">
            ...
            <p><label>uid:</label><br/><input type="text" name="uid" value="1" /></p>
            <p><label>oauth_token:</label><br/><input type="text" name="oauth_token" value="216655bc6ba25de534c45f75cc20a293" /></p>
            <p><label>oauth_token_secret:</label><br/><input type="text" name="oauth_token_secret" value="22c4a058d1488dd9ef9e4a084d4028cc" /></p>
        ...
        <!-- 发消息:输入状态 -->
        <form id="input_status_pack">
            <p><label>type:</label><br/><input type="text" name="type" value="input_status" readonly /></p>
            <p><label>room_id(房间ID):</label><br/><input type="text" name="room_id" value="" /></p>
            <p><label>to_uid(可选，指定接收用户):</label><br/><input type="text" name="to_uid" value="" skip="true" /></p>
            <p><label>status(输入状态,布尔值,此处可填0或1):</label><br/><input type="text" name="status" value="" /></p>
            <p><label>extend(可选，扩展参数):</label><br/><input type="text" name="extend" value="" skip="true" /></p>
            <p class="btn2"><input type="button" value="发送数据包" class="send_pack two" /><input type="button" value="生成数据包" class="create_pack two" /></p>
        </form>
        <!-- 发消息:文本 -->
        ...
        <form id="get_message_list_pack">
            ...
            <p><label>operator(操作符):</label><br/><input type="text" name="operator" value="" skip="true" /></p>
            <p><label>message_id(从ID开始):</label><br/><input type="text" name="message_id" value="" skip="true" /></p>
